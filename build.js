// Build Hestia-Mini front-end assets (JS + CSS) using esbuild and Lightning CSS.
//
// Hestia-Mini is its own project: the bundled panel UI must be compiled from
// web/js/src and web/css/src so that Mini-specific changes actually appear at
// runtime (the upstream `hestia` package only ships upstream's prebuilt files).
//
...
// Packages built as separate bundles and excluded from the main bundle.
...
async function build() {
	console.log('🚀 Building Hestia-Mini JS and CSS...');
	await buildJS();
