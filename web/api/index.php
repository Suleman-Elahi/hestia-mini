...
function api_legacy(array $request_data) {
	...
	// MiniPanel command allowlist - only permitted commands can be executed
	$allowed_commands = [
		// Mail
		'v-add-mail-account', 'v-add-mail-account-alias', 'v-add-mail-account-autoreply',
		'v-add-mail-account-forward', 'v-add-mail-account-fwd-only', 'v-add-mail-domain',
		'v-add-mail-domain-antispam', 'v-add-mail-domain-antivirus', 'v-add-mail-domain-catchall',
		'v-add-mail-domain-dkim', 'v-add-mail-domain-reject', 'v-add-mail-domain-smtp-relay',
		'v-add-mail-domain-ssl', 'v-add-mail-domain-webmail', 'v-change-mail-account-password',
		'v-change-mail-account-quota', 'v-change-mail-account-rate-limit',
		'v-change-mail-domain-catchall', 'v-change-mail-domain-rate-limit',
		'v-change-mail-domain-sslcert', 'v-delete-mail-account', 'v-delete-mail-account-alias',
		'v-delete-mail-account-autoreply', 'v-delete-mail-account-forward',
		'v-delete-mail-account-fwd-only', 'v-delete-mail-domain', 'v-delete-mail-domain-antispam',
		'v-delete-mail-domain-antivirus', 'v-delete-mail-domain-catchall',
		'v-delete-mail-domain-dkim', 'v-delete-mail-domain-reject',
		'v-delete-mail-domain-smtp-relay', 'v-delete-mail-domain-ssl',
		'v-delete-mail-domain-webmail', 'v-delete-mail-domains', 'v-get-mail-account-value',
		'v-get-mail-domain-value', 'v-list-mail-account', 'v-list-mail-account-autoreply',
		'v-list-mail-accounts', 'v-list-mail-domain', 'v-list-mail-domain-dkim',
		'v-list-mail-domain-dkim-dns', 'v-list-mail-domain-ssl', 'v-list-mail-domains',
		'v-suspend-mail-account', 'v-suspend-mail-accounts', 'v-suspend-mail-domain',
		'v-suspend-mail-domains', 'v-unsuspend-mail-account', 'v-unsuspend-mail-accounts',
		'v-unsuspend-mail-domain', 'v-unsuspend-mail-domains', 'v-update-mail-domain-disk',
		'v-update-mail-domain-ssl', 'v-update-mail-domains-disk', 'v-update-mail-templates',
		'v-restart-mail',
		// Database
		'v-add-database', 'v-add-database-host', 'v-add-database-temp-user',
		'v-change-database-host-password', 'v-change-database-owner',
		'v-change-database-password', 'v-change-database-user', 'v-delete-database',
		'v-delete-database-host', 'v-delete-databases', 'v-import-database',
		'v-list-database', 'v-list-database-host', 'v-list-database-hosts',
		'v-list-database-types', 'v-list-databases', 'v-rebuild-database',
		'v-rebuild-databases', 'v-suspend-database', 'v-suspend-database-host',
		'v-suspend-databases', 'v-unsuspend-database', 'v-unsuspend-database-host',
		'v-unsuspend-databases', 'v-update-database-disk', 'v-update-databases-disk',
		// User/Auth
		'v-add-user', 'v-add-user-2fa', 'v-add-user-notification', 'v-add-user-package',
		'v-add-user-sftp-jail', 'v-add-user-sftp-key', 'v-add-user-ssh-key',
		'v-check-user-2fa', 'v-check-user-hash', 'v-check-user-password',
		'v-copy-user-package', 'v-delete-access-key', 'v-delete-user', 'v-delete-user-2fa',
		'v-delete-user-auth-log', 'v-delete-user-notification', 'v-delete-user-package',
		'v-delete-user-ssh-key', 'v-generate-api-key', 'v-generate-password-hash',
		'v-get-user-salt', 'v-get-user-value', 'v-list-access-key', 'v-list-access-keys',
		'v-list-user', 'v-list-user-auth-log', 'v-list-user-log', 'v-list-user-notifications',
		'v-list-user-package', 'v-list-user-packages', 'v-list-user-ssh-key', 'v-list-users',
		'v-rename-user-package', 'v-revoke-api-key', 'v-change-user-contact',
		'v-change-user-language', 'v-change-user-name', 'v-change-user-package',
		'v-change-user-password', 'v-change-user-role', 'v-change-user-shell',
		'v-change-user-sort-order', 'v-change-user-template', 'v-change-user-theme',
		'v-update-user-counters', 'v-update-user-disk', 'v-update-user-package',
		'v-suspend-user', 'v-unsuspend-user',
		// System
		'v-list-sys-config', 'v-list-sys-info', 'v-list-sys-services', 'v-restart-service',
		'v-start-service', 'v-stop-service', 'v-list-sys-languages', 'v-change-sys-language',
		'v-search-object', 'v-search-user-object', 'v-search-command', 'v-log-action',
		'v-log-user-login', 'v-log-user-logout', 'v-change-sys-config-value',
		'v-change-sys-hostname', 'v-change-sys-port', 'v-change-sys-timezone',
		'v-list-sys-shells', 'v-list-sys-themes', 'v-list-sys-users', 'v-refresh-sys-theme',
		'v-update-sys-defaults', 'v-update-sys-queue',
		// File system
		'v-add-fs-archive', 'v-add-fs-directory', 'v-add-fs-file', 'v-change-fs-file-permission',
		'v-check-fs-permission', 'v-copy-fs-directory', 'v-copy-fs-file',
		'v-delete-fs-directory', 'v-delete-fs-file', 'v-extract-fs-archive',
		'v-get-fs-file-type', 'v-list-fs-directory', 'v-move-fs-directory', 'v-move-fs-file',
		'v-open-fs-config', 'v-open-fs-file',
		// SSL/Cert
		'v-generate-ssl-cert', 'v-restart-system',
		// Rebuild
		'v-rebuild-all', 'v-rebuild-mail-domain', 'v-rebuild-mail-domains',
		'v-rebuild-user', 'v-rebuild-users',
		// Misc
		'v-repair-sys-config', 'v-run-cli-cmd', 'v-update-sys-hestia',
		'v-acknowledge-user-notification', 'v-add-access-key', 'v-add-sys-dependencies',
		'v-add-sys-filemanager', 'v-add-sys-roundcube', 'v-add-sys-snappymail',
		'v-add-sys-smtp', 'v-add-sys-smtp-relay', 'v-check-access-key', 'v-check-api-key',
		'v-change-sys-api', 'v-change-sys-service-config', 'v-delete-sys-filemanager',
		'v-list-sys-hestia-ssl', 'v-list-sys-hestia-updates',
	];

	if (!in_array($hst_cmd, $allowed_commands)) {
		api_error(E_FORBIDDEN, "Command '$hst_cmd' is not allowed in MiniPanel", $hst_return);
	}

	// Check command
	if (false) {
		// v-make-tmp-file (DNS Cluster) is not part of MiniPanel - removed.
		$return_var = 0;
	} else {
		// Prepare command
...
function api_connection(array $request_data) {
	...
	$allowed_commands = [
		...
		'v-unsuspend-mail-domain', 'v-unsuspend-mail-domains', 'v-update-mail-domain-disk',
		'v-update-mail-domain-ssl', 'v-update-mail-domains-disk', 'v-update-mail-templates',
		'v-restart-mail', 'v-add-database', 'v-add-database-host', 'v-add-database-temp-user',
		'v-change-database-host-password', 'v-change-database-owner',
		'v-change-database-password', 'v-change-database-user', 'v-delete-database',
		'v-delete-database-host', 'v-delete-databases', 'v-import-database',
		'v-list-database', 'v-list-database-host', 'v-list-database-hosts',
		...
		'v-change-user-sort-order', 'v-change-user-template', 'v-change-user-theme',
		'v-update-user-counters', 'v-update-user-disk', 'v-update-user-package',
		'v-suspend-user', 'v-unsuspend-user', 'v-list-sys-config', 'v-list-sys-info',
		'v-list-sys-services', 'v-restart-service', 'v-start-service', 'v-stop-service',
		'v-list-sys-languages', 'v-change-sys-language', 'v-search-object',
		'v-search-user-object', 'v-search-command', 'v-log-action', 'v-log-user-login',
		'v-log-user-logout', 'v-change-sys-config-value', 'v-change-sys-hostname',
		'v-change-sys-port', 'v-change-sys-timezone', 'v-list-sys-shells',
		'v-list-sys-themes', 'v-list-sys-users', 'v-refresh-sys-theme',
		'v-update-sys-defaults', 'v-update-sys-queue', 'v-add-fs-archive',
		'v-add-fs-directory', 'v-add-fs-file', 'v-change-fs-file-permission',
		'v-check-fs-permission', 'v-copy-fs-directory', 'v-copy-fs-file',
		'v-delete-fs-directory', 'v-delete-fs-file', 'v-extract-fs-archive',
		'v-get-fs-file-type', 'v-list-fs-directory', 'v-move-fs-directory', 'v-move-fs-file',
		'v-open-fs-config', 'v-open-fs-file', 'v-generate-ssl-cert', 'v-restart-system',
		'v-rebuild-all', 'v-rebuild-mail-domain', 'v-rebuild-mail-domains',
		'v-rebuild-user', 'v-rebuild-users', 'v-repair-sys-config', 'v-run-cli-cmd',
		'v-update-sys-hestia', 'v-acknowledge-user-notification', 'v-add-access-key',
		'v-check-access-key', 'v-check-api-key', 'v-change-sys-api',
		'v-change-sys-service-config', 'v-list-sys-hestia-ssl', 'v-list-sys-hestia-updates',
	];
